...
//                   <Image src={item.image} alt={item.title} style={{ height: '50px', width: '50px', objectFit: 'contain' }} />
...
//                     >-</Button>
//                     <span className="px-2 d-flex align-items-center justify-content-center">
//                       {item.qty}
//                     </span>
//                     <Button
//                       variant="outline-secondary"
